...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  const { personId, fromDate, toDate, page, pageSize, sortBy, sortDir } = req.query;
  ...
  // Validate sorting
  const validSortFields = ['createdAt', 'amount', 'movementType'];
  ...
  try {
    ...
    console.error('Error getting debt and cashback summary:', error);
